...
h2o.randomForest.2 <- function(..., ntrees = 600, sample_rate = 0.75, seed = 1) {
...
h2o.gbm.1 <- function(..., ntrees = 300, seed = 1){
  h2o.gbm.wrapper(..., ntrees = ntrees, seed = seed)
}

h2o.gbm.2 <- function(..., ntrees = 300, max_depth = 10, seed = 1){
  h2o.gbm.wrapper(..., ntrees = ntrees, max_depth = max_depth, seed = seed)
}

h2o.gbm.3 <- function(..., ntrees = 300, col_sample_rate = 0.6, seed = 1){
